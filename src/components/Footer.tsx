    ...
    >
      ...
      <div className="container mx-auto px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <motion.div className="space-y-6" initial="rest" whileHover="hover" animate="rest">
            <motion.img
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              >
                <motion.a
                  href="#"
                  className="text-white transition-colors text-sm cursor-pointer px-2 py-1 rounded"
                  style={{ color: 'inherit' }}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 text-sm">
              <motion.div className="flex items-center gap-3 group" initial="rest" whileHover="hover" animate="rest">
